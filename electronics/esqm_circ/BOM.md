...
- controle e rastreabilidade de componentes;
- consulta técnica futura.

> 📌 **Observação:**  
> Este BOM refere-se **exclusivamente ao circuito eletrônico oficial**, não incluindo versões de teste ou componentes descartados durante o desenvolvimento.

---

## 🔋 Alimentação e Proteção

| Item | Qtd. | Componente | Especificação / Modelo | Observações |
|-----|-----|------------|------------------------|-------------|
| 1 | 1 | Bateria de lítio 2S | 7,4 – 7,8 V | Fonte principal de energia do robô |
| 2 | 1 | Módulo carregador de bateria de lítio | TP4056 (ou equivalente) | Permite recarga da bateria sem desmontar o robô |
...
| Item | Qtd. | Componente | Especificação / Modelo | Observações |
|-----|-----|------------|------------------------|-------------|
| 5 | 1 | ESP32 DevKit | ESP32-WROOM | Microcontrolador principal do robô |
| 6 | 1 | Placa de expansão ESP32 (roxa) | Expansion Board | Organização das conexões e regulação onboard |
| 7 | 1 | Controle Bluetooth | 8BitDo | Comunicação via Bluetooth utilizando Bluepad32 |
...
| Item | Qtd. | Componente | Especificação / Modelo | Observações |
|-----|-----|------------|------------------------|-------------|
| 8 | 1 | Ponte H | L298N | Driver de potência para dois motores DC |
...
| 13 | — | Terminais e jumpers | — | Conexões internas do circuito |

---

## 📌 Observações Finais

- As quantidades indicadas refletem **apenas o circuito eletrônico oficial**.
- Componentes emprestados do laboratório **G.E.A.R.** estão incluídos normalmente para fins de documentação.
- Este BOM não representa uma lista de compras, mas sim um **registro técnico do sistema construído**.
## 📌 Observações Gerais
